...
var createTestCases = []coretestcases.CaseV1{
	{
		...
		ArrangeInput: args.Map{
			"when": "given a valid digit pattern", "pattern": "\\d+",
		},
	...
	},
	{
		...
		ArrangeInput: args.Map{
			"when": "given a word boundary pattern", "pattern": "\\bhello\\b",
		},
		ExpectedInput: []string{"true", "false"},
	},
	{
		...
		ArrangeInput: args.Map{
			"when": "given an invalid pattern", "pattern": "[invalid",
		},
	...
	},
	{
		...
		ArrangeInput: args.Map{
			"when": "given an empty pattern", "pattern": "",
		},
		ExpectedInput: []string{"true", "false"},
	},
}
...
var isMatchLockTestCases = []coretestcases.CaseV1{
	{
		...
		ArrangeInput: args.Map{
			"when": "given matching digit input", "pattern": "\\d+", "input": "abc123",
		},
	...
	},
	{
		...
		ArrangeInput: args.Map{
			"when": "given non-matching input", "pattern": "^\\d+$", "input": "abc",
		},
	...
	},
	{
		...
		ArrangeInput: args.Map{
			"when": "given invalid regex pattern", "pattern": "[bad", "input": "anything",
		},
		ExpectedInput: []string{"false"},
	},
	{
		...
		ArrangeInput: args.Map{
			"when": "given exact match pattern", "pattern": "^hello$", "input": "hello",
		},
		ExpectedInput: []string{"true"},
	},
}
...
var isMatchFailedTestCases = []coretestcases.CaseV1{
	{
		...
		ArrangeInput: args.Map{
			"when": "given matching input", "pattern": "\\d+", "input": "123",
		},
		ExpectedInput: []string{"false"},
	},
	{
	...
	},
	{
		...
		ArrangeInput: args.Map{
			"when": "given invalid regex", "pattern": "[broken", "input": "test",
		},
		ExpectedInput: []string{"true"},
	},
}

var matchErrorMatchTestCase = coretestcases.CaseV1{
	Title: "MatchError returns no error on match",
	ArrangeInput: args.Map{
		"when": "given matching input to MatchError", "pattern": "^hello$", "input": "hello",
	},
	ExpectedInput: []string{"true"},
}

var matchErrorMismatchTestCase = coretestcases.CaseV1{
	Title: "MatchError returns error on mismatch",
	ArrangeInput: args.Map{
		"when": "given non-matching input to MatchError", "pattern": "^\\d+$", "input": "abc",
	},
	ExpectedInput: []string{"false"},
}

var matchErrorLockMatchTestCase = coretestcases.CaseV1{
	Title: "MatchErrorLock returns no error on match",
	ArrangeInput: args.Map{
		"when": "given matching input to MatchErrorLock", "pattern": "world", "input": "hello world",
	},
	ExpectedInput: []string{"true"},
}

var matchErrorLockMismatchTestCase = coretestcases.CaseV1{
	Title: "MatchErrorLock returns error on mismatch",
	ArrangeInput: args.Map{
		"when": "given non-matching input to MatchErrorLock", "pattern": "^xyz$", "input": "abc",
	},
	ExpectedInput: []string{"false"},
}
