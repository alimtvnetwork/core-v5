...
func Test_RangeString_NoSeparator_Cov2(t *testing.T) {
	rs := corerange.NewRangeString("hello", ":")
	actual := args.Map{
		"isValid": rs.IsValid,
	}
	expected := args.Map{
...
func Test_RangeInt8_Methods_Cov2(t *testing.T) {
	ri := corerange.NewRangeIntMinMax("2:5", ":", 0, 10)
	ri8 := ri.CreateRangeInt8()
	actual := args.Map{
		"rangeLength":    int(ri8.RangeLength()),
		"difference":     int(ri8.Difference()),
		"isWithin3":      ri8.IsWithinRange(3),
		"isWithin8":      ri8.IsWithinRange(8),
		"isInvalid8":     ri8.IsInvalidValue(8),
		"stringNotEmpty": ri8.String() != "",
		"rangesLen":      len(ri8.Ranges()),
		"rangesIntLen":   len(ri8.RangesInt()),
	}
	expected := args.Map{
		"rangeLength":    4,
		"difference":     3,
...
func Test_RangeInt16_Methods_Cov2(t *testing.T) {
	...
	ri16 := ri.CreateRangeInt16()
	actual := args.Map{
		"rangeLength":    int(ri16.RangeLength()),
		"difference":     int(ri16.Difference()),
		"isWithin3":      ri16.IsWithinRange(3),
		"stringNotEmpty": ri16.String() != "",
	}
	expected := args.Map{
		"rangeLength":    4,
		"difference":     3,
...
func Test_RangeByte_Methods_Cov2(t *testing.T) {
	...
	rb := ri.CreateRangeByte()
	actual := args.Map{
		"rangeLength":    int(rb.RangeLength()),
		"difference":     int(rb.Difference()),
		"isWithin3":      rb.IsWithinRange(3),
		"stringNotEmpty": rb.String() != "",
	}
	expected := args.Map{
		"rangeLength":    4,
		"difference":     3,
...
func Test_BaseRange_Clone_Cov2(t *testing.T) {
	...
	actual := args.Map{
		"rawInput":  cloned.RawInput,
		"separator": cloned.Separator,
		"isValid":   cloned.IsValid,
		"isInvalid": cloned.IsInvalid(),
	}
	expected := args.Map{
		"rawInput":  "1:5",
		"separator": ":",
...
func Test_RangeAny_NoSeparator_Cov2(t *testing.T) {
	ra := corerange.NewRangeAny("hello", ":")
	actual := args.Map{
		"isValid": ra.IsValid,
	}
	expected := args.Map{
...
// ── within helper (via IsWithinRange) ──
