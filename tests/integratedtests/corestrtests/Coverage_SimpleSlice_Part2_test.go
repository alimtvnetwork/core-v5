...
func Test_CovSS2_04_ConcatNewSimpleSlices(t *testing.T) {
	a := corestr.New.SimpleSlice.Items("a")
	b := corestr.New.SimpleSlice.Items("b")
...
func Test_CovSS2_06_Sort_Reverse(t *testing.T) {
	ss := corestr.New.SimpleSlice.Items("c", "a", "b")
	ss.Sort()
	if ss.First() != "a" {
	...
	// reverse 2 elements
	ss2 := corestr.New.SimpleSlice.Items("a", "b")
	ss2.Reverse()
	if ss2.First() != "b" {
		t.Fatal("expected b")
	}
...
func Test_CovSS2_08_MarshalJSON_UnmarshalJSON(t *testing.T) {
	...
	ss2 := corestr.New.SimpleSlice.Items()
...
func Test_CovSS2_14_Clear_Dispose(t *testing.T) {
	...
	ss2 := corestr.New.SimpleSlice.Items("x")
	ss2.Dispose()
}
...
func Test_CovSS2_16_IsDistinctEqualRaw_IsDistinctEqual(t *testing.T) {
	...
	other := corestr.New.SimpleSlice.Items("a", "b")
...
func Test_CovSS2_17_IsUnorderedEqualRaw(t *testing.T) {
	...
	// without clone
	ss2 := corestr.New.SimpleSlice.Items("b", "a")
...
func Test_CovSS2_22_DistinctDiff(t *testing.T) {
	...
	b := corestr.New.SimpleSlice.Items("b", "c")
	r := a.DistinctDiff(b)
	if len(r) != 2 {
		t.Fatalf("expected 2, got %d", len(r))
	}
...
func Test_CovSS2_25_Serialize_Deserialize(t *testing.T) {
	...
	target := corestr.New.SimpleSlice.Items()
