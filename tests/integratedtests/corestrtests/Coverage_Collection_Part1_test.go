...
func Test_CovP1_07_ListStrings(t *testing.T) {
	col := corestr.New.Collection.Items("x", "y")
...
func Test_CovP1_14_IsCollectionPrecheckEqual_AllPaths(t *testing.T) {
	a := corestr.New.Collection.Items("a", "b")
	b := corestr.New.Collection.Items("a", "b")
	...
	// diff length
	c := corestr.New.Collection.Items("a")
	if a.IsEquals(c) {
...
func Test_CovP1_15_IsEqualsWithSensitive_CaseInsensitive(t *testing.T) {
	a := corestr.New.Collection.Items("Hello", "World")
	b := corestr.New.Collection.Items("hello", "world")
	...
	// mismatch fold
	c := corestr.New.Collection.Items("hello", "OTHER")
	if a.IsEqualsWithSensitive(false, c) {
		t.Fatal("expected not equal")
	}

	// mismatch sensitive
	d := corestr.New.Collection.Items("Hello", "other")
...
func Test_CovP1_22_AsDefaultError(t *testing.T) {
	col := corestr.New.Collection.Items("err1", "err2")
...
func Test_CovP1_27_ToError(t *testing.T) {
	col := corestr.New.Collection.Items("e1")
	err := col.ToError(",")
	_ = err
}
...
func Test_CovP1_35_AddCollection(t *testing.T) {
	a := corestr.New.Collection.Items("a")
	b := corestr.New.Collection.Items("b", "c")
	a.AddCollection(b)
	if a.Length() != 3 {
		t.Fatal("expected 3")
	}
...
func Test_CovP1_45_First(t *testing.T) {
	col := corestr.New.Collection.Items("first", "second")
	if col.First() != "first" {
...
func Test_CovP1_46_Single(t *testing.T) {
	col := corestr.New.Collection.Items("only")
	if col.Single() != "only" {
...
func Test_CovP1_47_Last(t *testing.T) {
	col := corestr.New.Collection.Items("a", "b", "last")
	if col.Last() != "last" {
