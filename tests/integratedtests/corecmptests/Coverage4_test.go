...
func Test_Cov4_IsStringsEqualWithoutOrder_SameOrder(t *testing.T) {
	...
	expected := args.Map{"result": true}
	expected.ShouldBeEqual(t, 0, "IsStringsEqualWithoutOrder same unordered", actual)
}
...
func Test_Cov4_VersionSliceByte_DiffLen_LeftShorter(t *testing.T) {
	...
	expected := args.Map{"result": true}
	expected.ShouldBeEqual(t, 0, "VersionSliceByte left shorter", actual)
}
...
func Test_Cov4_VersionSliceByte_DiffLen_LeftLonger(t *testing.T) {
	...
	expected := args.Map{"result": true}
	expected.ShouldBeEqual(t, 0, "VersionSliceByte left longer", actual)
}
...
func Test_Cov4_VersionSliceInteger_DiffLen_LeftShorter(t *testing.T) {
	...
	expected := args.Map{"result": true}
	expected.ShouldBeEqual(t, 0, "VersionSliceInteger left shorter", actual)
}
...
func Test_Cov4_VersionSliceInteger_DiffLen_LeftLonger(t *testing.T) {
	...
	expected := args.Map{"result": true}
	expected.ShouldBeEqual(t, 0, "VersionSliceInteger left longer", actual)
}
