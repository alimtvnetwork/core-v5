...
func Test_I23_DynamicCollection_Empty(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "DynamicCollection Empty", actual)
}
...
func Test_I23_DynamicCollection_AddAny(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "DynamicCollection AddAny", actual)
}
...
func Test_I23_DynamicCollection_AddAnyNonNull(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "DynamicCollection AddAnyNonNull", actual)
}
...
func Test_I23_DynamicCollection_AddAnyMany(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "DynamicCollection AddAnyMany", actual)
}
...
func Test_I23_DynamicCollection_AddPtr(t *testing.T) {
	...
	actual := args.Map{"len": dc.Length()}
	expected := args.Map{"len": 1}
	expected.ShouldBeEqual(t, 0, "DynamicCollection AddPtr", actual)
}
...
func Test_I23_DynamicCollection_AddManyPtr(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "DynamicCollection AddManyPtr", actual)
}
...
func Test_I23_DynamicCollection_Items(t *testing.T) {
	...
	expected := args.Map{"len": 1}
	expected.ShouldBeEqual(t, 0, "DynamicCollection Items", actual)
}
...
func Test_I23_DynamicCollection_First_Last(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "DynamicCollection First/Last", actual)
}
...
func Test_I23_DynamicCollection_FirstDynamic_LastDynamic(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "DynamicCollection FirstDynamic/LastDynamic", actual)
}
...
func Test_I23_DynamicCollection_FirstOrDefault_Has(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "DynamicCollection FirstOrDefault has", actual)
}
...
func Test_I23_DynamicCollection_FirstOrDefaultDynamic(t *testing.T) {
	...
	expected := args.Map{"nil": true}
	expected.ShouldBeEqual(t, 0, "DynamicCollection FirstOrDefaultDynamic", actual)
}
...
func Test_I23_DynamicCollection_LastOrDefault_Has(t *testing.T) {
	...
	expected := args.Map{"notNil": true}
	expected.ShouldBeEqual(t, 0, "DynamicCollection LastOrDefault has", actual)
}
...
func Test_I23_DynamicCollection_LastOrDefaultDynamic(t *testing.T) {
	...
	expected := args.Map{"nil": true}
	expected.ShouldBeEqual(t, 0, "DynamicCollection LastOrDefaultDynamic", actual)
}
...
func Test_I23_DynamicCollection_HasIndex(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "DynamicCollection HasIndex", actual)
}
...
func Test_I23_DynamicCollection_Loop(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "DynamicCollection Loop", actual)
}
...
func Test_I23_DynamicCollection_RemoveAt(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "DynamicCollection RemoveAt", actual)
}
...
func Test_I23_DynamicCollection_AddAnyWithTypeValidation_Match(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "DynamicCollection AddAnyWithTypeValidation match", actual)
}
...
func Test_I23_DynamicCollection_AddAnyWithTypeValidation_Mismatch(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "DynamicCollection AddAnyWithTypeValidation mismatch", actual)
}
...
func Test_I23_DynamicCollection_AddAnyItemsWithTypeValidation_StopOnErr(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "DynamicCollection AddAnyItemsWithTypeValidation stop", actual)
}
...
func Test_I23_DynamicCollection_AddAnyItemsWithTypeValidation_ContinueOnErr(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "DynamicCollection AddAnyItemsWithTypeValidation continue", actual)
}
...
func Test_I23_DynamicCollection_AnyItems(t *testing.T) {
	...
	actual := args.Map{"len": len(items)}
	expected := args.Map{"len": 2}
	expected.ShouldBeEqual(t, 0, "DynamicCollection AnyItems", actual)
}
...
func Test_I23_DynamicCollection_AnyItemsCollection(t *testing.T) {
	...
	expected := args.Map{"len": 1}
	expected.ShouldBeEqual(t, 0, "DynamicCollection AnyItemsCollection", actual)
}
...
func Test_I23_DynamicCollection_Strings(t *testing.T) {
	...
	actual := args.Map{"len": len(strs)}
	expected := args.Map{"len": 1}
	expected.ShouldBeEqual(t, 0, "DynamicCollection Strings", actual)
}
...
func Test_I23_DynamicCollection_JsonString(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "DynamicCollection JsonString", actual)
}
...
func Test_I23_DynamicCollection_JsonStringMust(t *testing.T) {
	...
	actual := args.Map{"notEmpty": s != ""}
	expected := args.Map{"notEmpty": true}
	expected.ShouldBeEqual(t, 0, "DynamicCollection JsonStringMust", actual)
}
...
func Test_I23_DynamicCollection_UnmarshalJSON(t *testing.T) {
	...
	actual := args.Map{"noErr": err == nil}
	expected := args.Map{"noErr": true}
	expected.ShouldBeEqual(t, 0, "DynamicCollection UnmarshalJSON", actual)
}
...
func Test_I23_DynamicCollection_JsonResultsCollection(t *testing.T) {
	...
	expected := args.Map{"notNil": true}
	expected.ShouldBeEqual(t, 0, "DynamicCollection JsonResultsCollection", actual)
}
...
func Test_I23_DynamicCollection_JsonResultsPtrCollection(t *testing.T) {
	...
	actual := args.Map{"notNil": rc != nil}
	expected := args.Map{"notNil": true}
	expected.ShouldBeEqual(t, 0, "DynamicCollection JsonResultsPtrCollection", actual)
}
...
func Test_I23_DynamicCollection_ParseInjectUsingJson(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "DynamicCollection ParseInjectUsingJson", actual)
}
...
func Test_I23_DynamicCollection_JsonParseSelfInject(t *testing.T) {
	...
	actual := args.Map{"noErr": err == nil}
	expected := args.Map{"noErr": true}
	expected.ShouldBeEqual(t, 0, "DynamicCollection JsonParseSelfInject", actual)
}
...
func Test_I23_DynamicCollection_GetPagesSize(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "DynamicCollection GetPagesSize", actual)
}
...
func Test_I23_DynamicCollection_GetPagedCollection(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "DynamicCollection GetPagedCollection", actual)
}
...
func Test_I23_DynamicCollection_GetSinglePageCollection(t *testing.T) {
	...
	expected := args.Map{"len": 3}
	expected.ShouldBeEqual(t, 0, "DynamicCollection GetSinglePageCollection", actual)
}
...
func Test_I23_DynamicCollection_GetPagingInfo(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "DynamicCollection GetPagingInfo", actual)
}
...
func Test_I23_DynamicCollection_Nil_Length(t *testing.T) {
	...
	actual := args.Map{"len": dc.Length()}
	expected := args.Map{"len": 0}
	expected.ShouldBeEqual(t, 0, "DynamicCollection nil Length", actual)
}
...
func Test_I23_DynamicCollection_Nil_IsEmpty(t *testing.T) {
	...
	expected := args.Map{"empty": true}
	expected.ShouldBeEqual(t, 0, "DynamicCollection nil IsEmpty", actual)
}
...
func Test_I23_DynamicCollection_ParseInjectUsingJsonMust(t *testing.T) {
	...
	expected := args.Map{"notNil": true}
	expected.ShouldBeEqual(t, 0, "DynamicCollection ParseInjectUsingJsonMust", actual)
}
