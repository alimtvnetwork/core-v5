...
func Test_I15_KeyVal_KeyDynamicPtr(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "KeyVal KeyDynamicPtr", actual)
}
...
func Test_I15_KeyVal_ValueDynamicPtr(t *testing.T) {
	...
	actual := args.Map{"notNil": d != nil, "valid": d.IsValid()}
	expected := args.Map{"notNil": true, "valid": true}
	expected.ShouldBeEqual(t, 0, "KeyVal ValueDynamicPtr", actual)
}
...
func Test_I15_KeyVal_IsKeyNull_NotNull(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "KeyVal IsKeyNull not null", actual)
}
...
func Test_I15_KeyVal_IsValueNull_NotNull(t *testing.T) {
	...
	actual := args.Map{"isNull": kv.IsValueNull()}
	expected := args.Map{"isNull": false}
	expected.ShouldBeEqual(t, 0, "KeyVal IsValueNull not null", actual)
}
...
func Test_I15_KeyVal_ValueInt_NotInt(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "KeyVal ValueInt not int", actual)
}
...
func Test_I15_KeyVal_ValueUInt_NotUint(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "KeyVal ValueUInt not uint", actual)
}
...
func Test_I15_KeyVal_ValueStrings_NotSlice(t *testing.T) {
	...
	expected := args.Map{"nil": true}
	expected.ShouldBeEqual(t, 0, "KeyVal ValueStrings not slice", actual)
}
...
func Test_I15_KeyVal_ValueBool_NotBool(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "KeyVal ValueBool not bool", actual)
}
...
func Test_I15_KeyVal_ValueInt64_NotInt64(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "KeyVal ValueInt64 not int64", actual)
}
...
func Test_I15_KeyVal_KeyString(t *testing.T) {
	...
	expected := args.Map{"notEmpty": true}
	expected.ShouldBeEqual(t, 0, "KeyVal KeyString", actual)
}
...
func Test_I15_KeyVal_ValueString(t *testing.T) {
	...
	expected := args.Map{"notEmpty": true}
	expected.ShouldBeEqual(t, 0, "KeyVal ValueString", actual)
}
...
func Test_I15_KeyVal_KeyReflectSet(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "KeyVal KeyReflectSet", actual)
}
...
func Test_I15_KeyVal_ValueReflectSet(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "KeyVal ValueReflectSet", actual)
}
...
func Test_I15_KeyVal_ReflectSetTo(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "KeyVal ReflectSetTo", actual)
}
...
func Test_I15_KeyVal_ReflectSetToMust_Success(t *testing.T) {
	...
	expected := args.Map{"val": 42}
	expected.ShouldBeEqual(t, 0, "KeyVal ReflectSetToMust success", actual)
}
...
func Test_I15_KeyVal_CastKeyVal_Success(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "KeyVal CastKeyVal success", actual)
}
...
func Test_I15_NewCollection_Int_Cap(t *testing.T) {
	...
	actual := args.Map{"len": c.Length()}
	expected := args.Map{"len": 0}
	expected.ShouldBeEqual(t, 0, "New.Collection.Int.Cap", actual)
}
...
func Test_I15_NewCollection_Int_From(t *testing.T) {
	...
	actual := args.Map{"len": c.Length()}
	expected := args.Map{"len": 3}
	expected.ShouldBeEqual(t, 0, "New.Collection.Int.From", actual)
}
...
func Test_I15_NewCollection_Int64_Empty(t *testing.T) {
	...
	actual := args.Map{"len": c.Length()}
	expected := args.Map{"len": 0}
	expected.ShouldBeEqual(t, 0, "New.Collection.Int64.Empty", actual)
}
...
func Test_I15_NewCollection_Byte_Empty(t *testing.T) {
	...
	actual := args.Map{"len": c.Length()}
	expected := args.Map{"len": 0}
	expected.ShouldBeEqual(t, 0, "New.Collection.Byte.Empty", actual)
}
...
func Test_I15_NewCollection_Any_From(t *testing.T) {
	...
	actual := args.Map{"len": c.Length()}
	expected := args.Map{"len": 3}
	expected.ShouldBeEqual(t, 0, "New.Collection.Any.From", actual)
}
...
func Test_I15_NewCollection_Float64_Empty(t *testing.T) {
	...
	actual := args.Map{"len": c.Length()}
	expected := args.Map{"len": 0}
	expected.ShouldBeEqual(t, 0, "New.Collection.Float64.Empty", actual)
}
...
func Test_I15_NewCollection_Float32_Empty(t *testing.T) {
	...
	actual := args.Map{"len": c.Length()}
	expected := args.Map{"len": 0}
	expected.ShouldBeEqual(t, 0, "New.Collection.Float32.Empty", actual)
}
...
func Test_I15_NewCollection_ByteSlice_From(t *testing.T) {
	...
	actual := args.Map{"len": c.Length()}
	expected := args.Map{"len": 2}
	expected.ShouldBeEqual(t, 0, "New.Collection.ByteSlice.From", actual)
}
...
func Test_I15_NewCollection_Int_Clone(t *testing.T) {
	...
	actual := args.Map{"len": c.Length()}
	expected := args.Map{"len": 3}
	expected.ShouldBeEqual(t, 0, "New.Collection.Int.Clone", actual)
}
...
func Test_I15_NewCollection_Int_Items(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "New.Collection.Int.Items", actual)
}
