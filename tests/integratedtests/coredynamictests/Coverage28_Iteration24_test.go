...
func Test_I24_CastTo_NonMatchingType(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "CastTo non-matching", actual)
}
...
func Test_I24_CastTo_PointerOutput(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "CastTo pointer output", actual)
}
...
func Test_I24_CastTo_MultipleAccepted(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "CastTo multiple accepted", actual)
}
...
func Test_I24_CastedResult_IsNotNull(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "CastedResult IsNotNull", actual)
}
...
func Test_I24_CastedResult_IsNotPointer(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "CastedResult IsNotPointer", actual)
}
...
func Test_I24_CastedResult_IsNotMatchingAcceptedType(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "CastedResult IsNotMatchingAcceptedType", actual)
}
...
func Test_I24_CastedResult_IsSourceKind(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "CastedResult IsSourceKind", actual)
}
...
func Test_I24_CastedResult_HasAnyIssues_Valid(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "CastedResult HasAnyIssues valid", actual)
}
...
func Test_I24_MapAnyItemDiff_Length(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "MapAnyItemDiff Length", actual)
}
...
func Test_I24_MapAnyItemDiff_Length_Nil(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "MapAnyItemDiff Length nil", actual)
}
...
func Test_I24_MapAnyItemDiff_IsEmpty(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "MapAnyItemDiff IsEmpty", actual)
}
...
func Test_I24_MapAnyItemDiff_HasAnyItem(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "MapAnyItemDiff HasAnyItem", actual)
}
...
func Test_I24_MapAnyItemDiff_LastIndex(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "MapAnyItemDiff LastIndex", actual)
}
...
func Test_I24_MapAnyItemDiff_IsRawEqual_Diff(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "MapAnyItemDiff IsRawEqual diff", actual)
}
...
func Test_I24_MapAnyItemDiff_HashmapDiffUsingRaw_HasDiff(t *testing.T) {
	...
	expected := args.Map{"hasDiff": true}
	expected.ShouldBeEqual(t, 0, "MapAnyItemDiff HashmapDiffUsingRaw has diff", actual)
}
...
func Test_I24_MapAsKeyValSlice_Valid(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "MapAsKeyValSlice valid", actual)
}
...
func Test_I24_MapAsKeyValSlice_NonMap(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "MapAsKeyValSlice non-map", actual)
}
...
func Test_I24_TypeSameStatus_Same(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "TypeSameStatus same", actual)
}
...
func Test_I24_TypeSameStatus_Pointer(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "TypeSameStatus pointer", actual)
}
...
func Test_I24_ReflectTypeValidation_NilAllowed(t *testing.T) {
	...
	actual := args.Map{"hasErr": err != nil}
	expected := args.Map{"hasErr": true}
	expected.ShouldBeEqual(t, 0, "ReflectTypeValidation nil allowed but mismatch", actual)
}
...
func Test_I24_MustBeAcceptedTypes_NoPanic(t *testing.T) {
	...
	actual := args.Map{"ok": true}
	expected := args.Map{"ok": true}
	expected.ShouldBeEqual(t, 0, "MustBeAcceptedTypes no panic", actual)
}
...
func Test_I24_PointerOrNonPointer_NonPointer(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "PointerOrNonPointer non-ptr", actual)
}
...
func Test_I24_PointerOrNonPointer_PointerInput_NonPointerOutput(t *testing.T) {
	...
	actual := args.Map{"val": val}
	expected := args.Map{"val": "hello"}
	expected.ShouldBeEqual(t, 0, "PointerOrNonPointer ptr->non-ptr", actual)
}
...
func Test_I24_PointerOrNonPointerUsingReflectValue_NonPtr(t *testing.T) {
	...
	actual := args.Map{"val": val}
	expected := args.Map{"val": "hello"}
	expected.ShouldBeEqual(t, 0, "PointerOrNonPointerUsingReflectValue non-ptr", actual)
}
...
func Test_I24_PointerOrNonPointerUsingReflectValue_PtrInput_NonPtrOut(t *testing.T) {
	...
	actual := args.Map{"val": val}
	expected := args.Map{"val": "hello"}
	expected.ShouldBeEqual(t, 0, "PointerOrNonPointerUsingReflectValue ptr->non-ptr", actual)
}
...
func Test_I24_LengthOfReflect_Other(t *testing.T) {
	...
	actual := args.Map{"len": coredynamic.LengthOfReflect(rv)}
	expected := args.Map{"len": 0}
	expected.ShouldBeEqual(t, 0, "LengthOfReflect other", actual)
}
...
func Test_I24_LengthOfReflect_Pointer(t *testing.T) {
	...
	actual := args.Map{"len": coredynamic.LengthOfReflect(rv)}
	expected := args.Map{"len": 2}
	expected.ShouldBeEqual(t, 0, "LengthOfReflect pointer", actual)
}
...
func Test_I24_DynamicStatus_InvalidNoMessage(t *testing.T) {
	...
	actual := args.Map{"valid": ds.IsValid(), "msg": ds.Message}
	expected := args.Map{"valid": false, "msg": ""}
	expected.ShouldBeEqual(t, 0, "DynamicStatus invalid no msg", actual)
}
...
func Test_I24_DynamicStatus_ClonePtr(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "DynamicStatus ClonePtr", actual)
}
...
func Test_I24_MapAnyItemDiff_IsRawEqual_RegardlessType(t *testing.T) {
	...
	expected := args.Map{"eq": true}
	expected.ShouldBeEqual(t, 0, "MapAnyItemDiff IsRawEqual regardless type", actual)
}
