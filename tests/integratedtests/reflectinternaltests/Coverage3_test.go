...
func Test_Cov3_Is_Number(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "Is Number", actual)
}
...
func Test_Cov3_Is_String(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "Is String", actual)
}
...
func Test_Cov3_Is_Pointer(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "Is Pointer", actual)
}
...
func Test_Cov3_Is_Function(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "Is Function", actual)
}
...
func Test_Cov3_Is_Boolean(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "Is Boolean", actual)
}
...
func Test_Cov3_Is_Primitive(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "Is Primitive", actual)
}
...
func Test_Cov3_Is_Zero(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "Is Zero", actual)
}
...
func Test_Cov3_Is_Struct(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "Is Struct", actual)
}
...
func Test_Cov3_Is_AnyEqual(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "Is AnyEqual", actual)
}
...
func Test_Cov3_Is_Conclusive(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "Is Conclusive", actual)
}
...
func Test_Cov3_Is_SliceOrArray(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "Is SliceOrArray", actual)
}
...
func Test_Cov3_FileWithLine(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "FileWithLine", actual)
}
...
func Test_Cov3_StackTrace(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "StackTrace", actual)
}
...
func Test_Cov3_StackTrace_Nil(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "StackTrace Nil", actual)
}
...
func Test_Cov3_StackTrace_Clone(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "StackTrace Clone", actual)
}
...
func Test_Cov3_StackTrace_Dispose(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "StackTrace Dispose", actual)
}
...
func Test_Cov3_StackTrace_JsonModel(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "StackTrace JsonModel", actual)
}
...
func Test_Cov3_StackTrace_StringUsingFmt(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "StackTrace StringUsingFmt", actual)
}
...
func Test_Cov3_CodeStack_New(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "CodeStack New", actual)
}
...
func Test_Cov3_CodeStack_MethodName(t *testing.T) {
	...
	expected := args.Map{"notEmpty": true}
	expected.ShouldBeEqual(t, 0, "CodeStack MethodName", actual)
}
...
func Test_Cov3_CodeStack_MethodNameWithLine(t *testing.T) {
	...
	actual := args.Map{"notEmpty": name != ""}
	expected := args.Map{"notEmpty": true}
	expected.ShouldBeEqual(t, 0, "CodeStack MethodNameWithLine", actual)
}
...
func Test_Cov3_CodeStack_FileWithLine(t *testing.T) {
	...
	actual := args.Map{"notEmpty": result != ""}
	expected := args.Map{"notEmpty": true}
	expected.ShouldBeEqual(t, 0, "CodeStack FileWithLine", actual)
}
...
func Test_Cov3_CodeStack_FilePath(t *testing.T) {
	...
	actual := args.Map{"notEmpty": result != ""}
	expected := args.Map{"notEmpty": true}
	expected.ShouldBeEqual(t, 0, "CodeStack FilePath", actual)
}
...
func Test_Cov3_CodeStack_LastFileWithLines(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "CodeStack LastFileWithLines", actual)
}
...
func Test_Cov3_CodeStack_NewFileWithLines(t *testing.T) {
	...
	actual := args.Map{"len": len(lines)}
	expected := args.Map{"len": 2}
	expected.ShouldBeEqual(t, 0, "CodeStack NewFileWithLines", actual)
}
...
func Test_Cov3_CodeStack_NewFileWithLine(t *testing.T) {
	...
	expected := args.Map{"notEmpty": true}
	expected.ShouldBeEqual(t, 0, "CodeStack NewFileWithLine", actual)
}
...
func Test_Cov3_ReflectConverter_ArgsToReflectValues(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "ArgsToReflectValues", actual)
}
