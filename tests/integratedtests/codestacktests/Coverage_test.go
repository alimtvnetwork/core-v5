...
func Test_NameOf_Method(t *testing.T) {
	// Act
	name := codestack.NameOf.Method("github.com/alimtvnetwork/core/codestack.Test_NameOf_Method")
...
func Test_NameOf_Package(t *testing.T) {
	// Act
	name := codestack.NameOf.Package("github.com/alimtvnetwork/core/codestack.Test_NameOf_Package")
...
func Test_NameOf_All(t *testing.T) {
	// Act
	full, pkg, method := codestack.NameOf.All("github.com/alimtvnetwork/core/codestack.Test_NameOf_All")
