...
var (
	...
	oneFuncTypeVerification = &coretests.VerifyTypeOf{
		ArrangeInput:  reflect.TypeOf([]coretestargs.OneFunc{}),
		ActualInput:   reflect.TypeOf([]string{}),
		ExpectedInput: reflect.TypeOf([]string{}),
	}
	...
	nullTestCases = []testWrapper{
		{
			BaseTestCase: coretests.BaseTestCase{
				...
				ExpectedInput: []string{
					...
					"1 : false (value: &{<nil> <nil> <nil>}, type: *coretestargs.Two)",
					"2 : true (value: <nil>, type: *coretestargs.Two)",
					"3 : false (value: 1, type: int)",
					"4 : false (value: 2, type: int)",
					"5 : false (value: {<nil> <nil> <nil>}, type: coretestargs.Two)",
				},
	...
	allNullTestCases = []testWrapper{
		{
			BaseTestCase: coretests.BaseTestCase{
				...
				ExpectedInput: []string{
					"0 : false (<nil>, *coretestargs.Two, *coretestargs.Two, int, int, coretestargs.Two)",
				},
				VerifyTypeOf: arrangeTypeVerification,
				IsEnable:     issetter.True,
			},
		},
		{
			BaseTestCase: coretests.BaseTestCase{
				...
				ExpectedInput: []string{
					"1 : true (<nil>, *coretestargs.Two, *coretestargs.Two, <nil>)",
				},
				VerifyTypeOf: arrangeTypeVerification,
				IsEnable:     issetter.True,
			},
	...
	anyNullTestCases = []testWrapper{
		{
			BaseTestCase: coretests.BaseTestCase{
				...
				ExpectedInput: []string{
					"0 : true (*coretestargs.Two, int, int, coretestargs.Two, *coretestargs.Two)",
				},
				VerifyTypeOf: arrangeTypeVerification,
				IsEnable:     issetter.True,
			},
	...
	definedTestCases = []testWrapper{
		{
			BaseTestCase: coretests.BaseTestCase{
				...
				ExpectedInput: []string{
					"0 : true (value: &{<nil> <nil> <nil>}, type: *coretestargs.Two)",
					"1 : true (value: 1, type: int)",
					"2 : false (value: <nil>, type: <nil>)",
					"3 : true (value: {<nil> <nil> <nil>}, type: coretestargs.Two)",
					"4 : false (value: <nil>, type: *coretestargs.Two)",
				},
				VerifyTypeOf: arrangeTypeVerification,
				IsEnable:     issetter.True,
			},
	...
	bothDefinedTestCases = []testWrapper{
		{
			BaseTestCase: coretests.BaseTestCase{
				...
				ExpectedInput: []string{
					"0 : false (<nil>, <nil>)",
					"1 : false (<nil>, *coretestargs.Two)",
					"2 : false (*coretestargs.Two, <nil>)",
					"3 : false (*coretestargs.Two, *coretestargs.Two)",
					"4 : false (int, *coretestargs.Two)",
					"5 : false (*coretestargs.Two, int)",
					"6 : false (int, <nil>)",
					"7 : false (<nil>, int)",
					"8 : true (int, int)",
					"9 : true (*coretestargs.Two, int)",
					"10 : true (*coretestargs.Two, coretestargs.Two)",
				},
	...
	nullBothTestCases = []testWrapper{
		{
			BaseTestCase: coretests.BaseTestCase{
				...
				ExpectedInput: []string{
					"0 : true (<nil>, <nil>)",
					"1 : true (<nil>, *coretestargs.Two)",
					"2 : true (*coretestargs.Two, <nil>)",
					"3 : true (*coretestargs.Two, *coretestargs.Two)",
					"4 : false (int, *coretestargs.Two)",
					"5 : false (*coretestargs.Two, int)",
					"6 : false (int, <nil>)",
					"7 : false (<nil>, int)",
					"8 : false (int, int)",
					"9 : false (*coretestargs.Two, int)",
					"10 : false (*coretestargs.Two, coretestargs.Two)",
				},
				VerifyTypeOf: twoArgsTypeVerification,
				IsEnable:     issetter.True,
			},
	...
	definedAllOfTestCases = []testWrapper{
		{
			BaseTestCase: coretests.BaseTestCase{
				...
				ExpectedInput: []string{
					...
					"2 : false (int, int, *coretestargs.Two)",
	...
	definedAnyOfTestCases = []testWrapper{
		{
			BaseTestCase: coretests.BaseTestCase{
				...
				ExpectedInput: []string{
					...
					"2 : true (int, int, *coretestargs.Two)",
					"3 : true (string, int, float64)",
					"4 : false (<nil>, *coretestargs.Two, *coretestargs.Two)",
				},
				VerifyTypeOf: interfaceArrayTypeVerification,
				IsEnable:     issetter.True,
			},
	...
	conclusiveTestCases = []testWrapper{
		{
			BaseTestCase: coretests.BaseTestCase{
				...
				ExpectedInput: []string{
					...
					"1 - Equal : true - Conclusive ('<nil> - *coretestargs.Two', '<nil> - *coretestargs.Two')",
				},
				VerifyTypeOf: twoArgsTypeVerification,
				IsEnable:     issetter.True,
			},
		},
		{
			BaseTestCase: coretests.BaseTestCase{
				...
				ExpectedInput: []string{
					"0 - Equal : false - Conclusive ('<nil>', '<nil> - *coretestargs.Two')",
					"1 - Equal : false - Conclusive ('<nil> - *coretestargs.Two', '<nil>')",
				},
				VerifyTypeOf: twoArgsTypeVerification,
				IsEnable:     issetter.True,
			},
	...
	reflectionTypesTestCases = []testWrapper{
		{
			BaseTestCase: coretests.BaseTestCase{
				...
				ExpectedInput: []string{
					...
					"1 : false (type: coretestargs.Two, PrimitiveType, {<nil> <nil> <nil>})",
		...
		},
		{
			BaseTestCase: coretests.BaseTestCase{
				...
				ExpectedInput: []string{
					...
					"1 : false (type: coretestargs.Two, FloatingPointType, {<nil> <nil>})",
		...
		},
		{
			BaseTestCase: coretests.BaseTestCase{
				...
				ExpectedInput: []string{
					...
					"6 : false (type: coretestargs.Two, PositiveIntegerType, {<nil> <nil>})",
		...
		},
		{
			BaseTestCase: coretests.BaseTestCase{
				...
				ExpectedInput: []string{
					...
					"1 : false (type: coretestargs.Two, FuncOnly, FuncOnly)",
					"2 : false (type: string, FuncOnly, FuncOnly)",
					"3 : false (type: *coretestargs.Two, FuncOnly, FuncOnly)",
