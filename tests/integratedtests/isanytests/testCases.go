	...
	nullTestCases = []testWrapper{
		{
			BaseTestCase: coretests.BaseTestCase{
				...
				ExpectedInput: []string{
					...
					"1 : false (value: &{<nil> <nil> <nil>}, type: *args.Two)",
					"2 : true (value: <nil>, type: *args.Two)",
					"3 : false (value: 1, type: int)",
					"4 : false (value: 2, type: int)",
					"5 : false (value: {<nil> <nil> <nil>}, type: args.Two)",
				},
	...
	definedTestCases = []testWrapper{
		{
			BaseTestCase: coretests.BaseTestCase{
				...
				ExpectedInput: []string{
					"0 : true (value: &{<nil> <nil> <nil>}, type: *args.Two)",
					"1 : true (value: 1, type: int)",
					"2 : false (value: <nil>, type: <nil>)",
					"3 : true (value: {<nil> <nil> <nil>}, type: args.Two)",
	...
	reflectionTypesTestCases = []testWrapper{
		{
			BaseTestCase: coretests.BaseTestCase{
				...
				ExpectedInput: []string{
					...
					"1 : false (type: args.Two, PrimitiveType, {<nil> <nil> <nil>})",
		...
		},
		{
			BaseTestCase: coretests.BaseTestCase{
				...
				ExpectedInput: []string{
					...
					"1 : false (type: args.Two, FloatingPointType, {<nil> <nil> <nil>})",
