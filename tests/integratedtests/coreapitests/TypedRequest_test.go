...
// ==========================================
// Test: TypedRequest ToGenericRequestIn
// ==========================================

func Test_TypedRequest_ToGenericRequestIn_Verification(t *testing.T) {
	for caseIndex, testCase := range typedRequestToGenericRequestInTestCases {
		// Arrange
		input := testCase.ArrangeInput.(args.Map)
		payload, _ := input.GetAsString("payload")
...
func Test_TypedRequest_ToGenericRequestIn_Nil_Verification(t *testing.T) {
	for caseIndex, testCase := range typedRequestToGenericRequestInNilTestCases {
		// Arrange
		var req *coreapi.TypedRequest[string]
...
// ==========================================
// Test: TypedRequest ToSimpleGenericRequest
// ==========================================

func Test_TypedRequest_ToSimpleGenericRequest_Verification(t *testing.T) {
	for caseIndex, testCase := range typedRequestToSimpleGenericRequestTestCases {
		// Arrange
		input := testCase.ArrangeInput.(args.Map)
		payload, _ := input.GetAsString("payload")
		...
		// Act
		sgr := req.ToSimpleGenericRequest(true, "")
		actLines := []string{
			fmt.Sprintf("%v", sgr != nil),
...
func Test_TypedRequest_ToSimpleGenericRequest_Nil_Verification(t *testing.T) {
	for caseIndex, testCase := range typedRequestToSimpleGenericRequestNilTestCases {
		// Arrange
		var req *coreapi.TypedRequest[string]
...
// ==========================================
// Test: TypedResponseResult ToGenericResponseResult
// ==========================================

func Test_TypedResponseResult_ToGenericResponseResult_Verification(t *testing.T) {
	for caseIndex, testCase := range typedResponseResultToGenericTestCases {
		// Arrange
		input := testCase.ArrangeInput.(args.Map)
		...
		// Act
		grr := result.ToGenericResponseResult()
		actLines := []string{
...
func Test_TypedResponseResult_ToGenericResponseResult_Nil_Verification(t *testing.T) {
	for caseIndex, testCase := range typedResponseResultToGenericNilTestCases {
		// Arrange
