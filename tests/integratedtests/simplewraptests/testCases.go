...
var (
	...
	doubleQuoteWrapWithCheckingTestCases = []testWrapper{
		{
			BaseTestCase: coretests.BaseTestCase{
				Title: "Given strings will be wrapped with double quote with checking. " +
					"Double wrapped guaranteed, duplicate wrap not possible.",
				ArrangeInput: []string{
					"alim",
					"created",
					"\"double quote\"",
	...
	doubleQuoteWrapWithNoCheckingTestCases = []testWrapper{
		{
			BaseTestCase: coretests.BaseTestCase{
				Title: "Given strings will be wrapped with double quote with NO checking. " +
					"Double wrapped guaranteed, duplicate wrap is possible.",
				ArrangeInput: []string{
					"alim",
					"created",
					"\"double quote\"",
