...
func Test_New_Valid_Cov2(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "New_Valid", actual)
}
...
func Test_New_Invalid_Cov2(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "New_Invalid", actual)
}
...
func Test_NewMust_Valid_Cov2(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "NewMust_Valid", actual)
}
...
func Test_CombinedBooleans_Cov2(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "CombinedBooleans", actual)
}
...
func Test_GetSetterByComparing_Cov2(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "GetSetterByComparing", actual)
}
...
func Test_IsCompareResult_Cov2(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "IsCompareResult", actual)
}
...
func Test_IsOutOfRange_Cov2(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "IsOutOfRange", actual)
}
...
func Test_Value_Methods_Cov2(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "Value_Methods", actual)
}
...
func Test_Value_Add_Cov2(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "Value_Add", actual)
}
...
func Test_Value_IsNegative_Cov2(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "Value_IsNegative", actual)
}
...
func Test_Value_IsPositive_Cov2(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "Value_IsPositive", actual)
}
...
func Test_Value_GetErrorOnOutOfRange_Cov2(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "Value_GetErrorOnOutOfRange", actual)
}
...
func Test_Value_NameMethods_Cov2(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "Value_NameMethods", actual)
}
...
func Test_Value_Serialize_Cov2(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "Value_Serialize", actual)
}

func Test_Value_TypeName_Cov2(t *testing.T) {
	actual := args.Map{"notEmpty": issetter.True.TypeName() != ""}
	expected := args.Map{"notEmpty": true}
	expected.ShouldBeEqual(t, 0, "Value_TypeName", actual)
}
...
func Test_Value_IsAnyValuesEqual_Cov2(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "Value_IsAnyValuesEqual", actual)
}
...
func Test_Value_UnmarshallEnumToValue_Cov2(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "Value_UnmarshallEnumToValue", actual)
}
...
func Test_Value_Deserialize_Cov2(t *testing.T) {
	...
	actual := args.Map{"hasErr": err != nil, "isTrue": v == issetter.True}
	expected := args.Map{"hasErr": false, "isTrue": true}
	expected.ShouldBeEqual(t, 0, "Value_Deserialize_Valid", actual)
}
...
func Test_Value_Deserialize_Invalid_Cov2(t *testing.T) {
	...
	actual := args.Map{"hasErr": err != nil}
	expected := args.Map{"hasErr": true}
	expected.ShouldBeEqual(t, 0, "Value_Deserialize_Invalid", actual)
}
...
func Test_Value_UnmarshalJSON_Cov2(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "Value_UnmarshalJSON", actual)
}
...
func Test_Value_MinMaxByte_Cov2(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "Value_MinMaxByte", actual)
}
...
func Test_Value_ToPtr_Cov2(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "Value_ToPtr", actual)
}
...
func Test_Value_ValueUInt16_Cov2(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "Value_ValueUInt16", actual)
}
...
func Test_PackageLevelFuncs_Cov2(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "PackageLevelFuncs", actual)
}
...
func Test_Value_OnlySupportedErr_Empty_Cov2(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "Value_OnlySupportedErr_Empty", actual)
}
...
func Test_Value_OnlySupportedMsgErr_Nil_Cov2(t *testing.T) {
	...
	expected := args.Map{"hasErr": false}
	expected.ShouldBeEqual(t, 0, "Value_OnlySupportedMsgErr_Nil", actual)
}
