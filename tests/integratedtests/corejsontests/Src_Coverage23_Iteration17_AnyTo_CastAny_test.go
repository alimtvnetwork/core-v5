...
func Test_I17_AnyTo_SerializedJsonResult_Result(t *testing.T) {
	...
	r := corejson.AnyTo.SerializedJsonResult(result)
	if r == nil {
...
func Test_I17_AnyTo_SerializedJsonResult_Bytes(t *testing.T) {
	r := corejson.AnyTo.SerializedJsonResult([]byte(`"hi"`))
...
func Test_I17_AnyTo_SerializedJsonResult_Serializer(t *testing.T) {
	...
	r := corejson.AnyTo.SerializedJsonResult(s)
	if r == nil {
		t.Fatal("expected non-nil")
	}
}
...
func Test_I17_AnyTo_SerializedStringMust_Panic(t *testing.T) {
	...
	corejson.AnyTo.SerializedStringMust(nil)
}
...
func Test_I17_AnyTo_SafeJsonPrettyString_Result(t *testing.T) {
	s := corejson.AnyTo.SafeJsonPrettyString(corejson.New("hello"))
	if s == "" {
		t.Fatal("expected non-empty")
	}
}
...
func Test_I17_AnyTo_SafeJsonPrettyString_ResultPtr(t *testing.T) {
	s := corejson.AnyTo.SafeJsonPrettyString(corejson.NewPtr("hello"))
	if s == "" {
		t.Fatal("expected non-empty")
	}
}
...
func Test_I17_AnyTo_JsonStringWithErr_Bytes(t *testing.T) {
	s, err := corejson.AnyTo.JsonStringWithErr([]byte(`"hi"`))
	if err != nil || s != `"hi"` {
		t.Fatal("unexpected")
	}
}
...
func Test_I17_AnyTo_JsonStringWithErr_Result(t *testing.T) {
	s, err := corejson.AnyTo.JsonStringWithErr(corejson.New("hello"))
	if err != nil || s == "" {
		t.Fatal("unexpected")
	}
}
...
func Test_I17_AnyTo_JsonStringWithErr_ResultPtr(t *testing.T) {
	s, err := corejson.AnyTo.JsonStringWithErr(corejson.NewPtr("hello"))
	if err != nil || s == "" {
		t.Fatal("unexpected")
	}
}
...
func Test_I17_AnyTo_JsonStringMust_Panic(t *testing.T) {
	...
	corejson.AnyTo.JsonStringMust(func() {})
}
...
func Test_I17_AnyTo_PrettyStringMust_Panic(t *testing.T) {
	...
	corejson.AnyTo.PrettyStringMust(func() {})
}

func Test_I17_AnyTo_UsingSerializer(t *testing.T) {
	s := testSerializer{data: []byte(`"x"`)}
	r := corejson.AnyTo.UsingSerializer(s)
	if r == nil {
		t.Fatal("expected non-nil")
	}
}
...
func Test_I17_CastAny_FromToDefault_Bytes(t *testing.T) {
	var n int
	err := corejson.CastAny.FromToDefault([]byte("42"), &n)
	if err != nil || n != 42 {
		t.Fatal("unexpected")
	}
}
...
func Test_I17_CastAny_FromToDefault_String(t *testing.T) {
	var n int
	err := corejson.CastAny.FromToDefault("42", &n)
	if err != nil || n != 42 {
		t.Fatal("unexpected")
	}
}
...
func Test_I17_CastAny_FromToReflection(t *testing.T) {
	var n int
	err := corejson.CastAny.FromToReflection([]byte("42"), &n)
	if err != nil || n != 42 {
		t.Fatal("unexpected")
	}
}
...
func Test_I17_CastAny_FromToOption_SkipReflection(t *testing.T) {
	var n int
	err := corejson.CastAny.FromToOption(false, []byte("42"), &n)
	if err != nil || n != 42 {
		t.Fatal("unexpected")
	}
}
...
func Test_I17_CastAny_FromToOption_NilFrom(t *testing.T) {
	var n int
	err := corejson.CastAny.FromToOption(true, nil, &n)
	if err == nil {
...
func Test_I17_CastAny_FromToOption_Result(t *testing.T) {
	r := corejson.New("hello")
	var s string
	err := corejson.CastAny.FromToOption(false, r, &s)
	if err != nil || s != "hello" {
		t.Fatal("unexpected")
	}
}
...
func Test_I17_CastAny_FromToOption_AnyFallback(t *testing.T) {
	...
	var to sample
	err := corejson.CastAny.FromToOption(false, from, &to)
...
func Test_I17_CastAny_OrDeserializeTo(t *testing.T) {
	var n int
	err := corejson.CastAny.OrDeserializeTo([]byte("42"), &n)
	if err != nil || n != 42 {
		t.Fatal("unexpected")
	}
}
...
func Test_I17_CastAny_ReflectionCasting_SameType(t *testing.T) {
	...
	from := &sample{N: 42}
	to := &sample{}
	err := corejson.CastAny.FromToOption(true, from, to)
	if err != nil {
...
func Test_I17_CastAny_ReflectionCasting_DiffType(t *testing.T) {
	var n int
	err := corejson.CastAny.FromToOption(true, "42", &n)
	if err != nil || n != 42 {
		t.Fatal("unexpected")
	}
}
