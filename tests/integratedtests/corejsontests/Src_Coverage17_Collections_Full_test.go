...
func TestBytesCollection_AddBytesCollection(t *testing.T) {
	bc := corejson.NewBytesCollection.UsingCap(5)
	bc2 := corejson.NewBytesCollection.UsingCap(5)
	bc2.Add([]byte(`"a"`))
...
func TestResultsCollection_Take(t *testing.T) {
	rc := corejson.NewResultsCollection.UsingCap(5)
	rc.Add(corejson.NewResult.Any("a")).Add(corejson.NewResult.Any("b"))
	r := rc.Take(1)
	if r.Length() != 1 { t.Fatal("expected 1") }
}
...
func TestResultsCollection_AddResultsCollection(t *testing.T) {
	rc1 := corejson.NewResultsCollection.UsingCap(5)
	rc1.Add(corejson.NewResult.Any("a"))
	rc2 := corejson.NewResultsCollection.UsingCap(5)
...
func TestResultsCollection_NonPtr(t *testing.T) {
	rc := ResultsCollection{Items: []corejson.Result{corejson.NewResult.Any("a")}}
	_ = rc.NonPtr()
}
...
func TestResultsCollection_GetPagesSize(t *testing.T) {
	...
	for i := 0; i < 10; i++ { rc.Add(corejson.NewResult.Any("a")) }
...
func TestMapResults_AddMapResults(t *testing.T) {
	mr1 := corejson.Empty.MapResults()
	mr1.Add("a", corejson.NewResult.Any("1"))
	mr2 := corejson.Empty.MapResults()
...
func TestMapResults_AddMapResultsUsingCloneOption(t *testing.T) {
	mr := corejson.Empty.MapResults()
	items := map[string]corejson.Result{"a": corejson.NewResult.Any("1")}
...
func TestResultsPtrCollection_AddResult(t *testing.T) {
	rpc := corejson.NewResultsPtrCollection.UsingCap(5)
	rpc.AddResult(corejson.NewResult.Any("a"))
	if rpc.Length() != 1 { t.Fatal("expected 1") }
}
...
func TestResultsPtrCollection_AddResultsCollection(t *testing.T) {
	rpc1 := corejson.NewResultsPtrCollection.UsingCap(5)
	r := corejson.NewResult.Any("a")
	rpc1.Add(&r)
	rpc2 := corejson.NewResultsPtrCollection.UsingCap(5)
