...
func TestDeserializer_FromTo(t *testing.T) {
	var out string
	err := corejson.Deserialize.FromTo([]byte(`"hi"`), &out)
...
func TestDeserializer_MapAnyToPointer_Valid(t *testing.T) {
	...
	var out simple
	err := corejson.Deserialize.MapAnyToPointer(false, map[string]any{"name": "test"}, &out)
...
func TestDeserializer_UsingStringOption_NotIgnore(t *testing.T) {
	var s string
	err := corejson.Deserialize.UsingStringOption(false, `"hi"`, &s)
...
func TestDeserializer_UsingStringIgnoreEmpty_Valid(t *testing.T) {
	var s string
	err := corejson.Deserialize.UsingStringIgnoreEmpty(`"hi"`, &s)
	if err != nil || s != "hi" { t.Fatal("unexpected") }
}

func TestDeserializer_UsingBytesIf_Skip(t *testing.T) {
	var s string
	err := corejson.Deserialize.UsingBytesIf(false, nil, &s)
	if err != nil { t.Fatal("expected nil") }
}

func TestDeserializer_UsingBytesIf_Do(t *testing.T) {
	var s string
	err := corejson.Deserialize.UsingBytesIf(true, []byte(`"hi"`), &s)
	if err != nil || s != "hi" { t.Fatal("unexpected") }
}
...
func TestDeserializer_UsingBytesPointerIf_Skip(t *testing.T) {
	var s string
	err := corejson.Deserialize.UsingBytesPointerIf(false, nil, &s)
	if err != nil { t.Fatal("expected nil") }
}

func TestDeserializer_UsingBytesPointerIf_Do(t *testing.T) {
	var s string
	err := corejson.Deserialize.UsingBytesPointerIf(true, []byte(`"hi"`), &s)
	if err != nil || s != "hi" { t.Fatal("unexpected") }
}
...
func TestBytesTo_Integer64(t *testing.T) {
	v, err := corejson.Deserialize.BytesTo.Integer64([]byte(`64`))
...
func TestBytesTo_Bytes(t *testing.T) {
	_, err := corejson.Deserialize.BytesTo.Bytes([]byte(`"aGVsbG8="`))
	if err != nil { t.Fatal("unexpected") }
}
...
func TestResultTo_Byte(t *testing.T) {
	r := corejson.NewResult.AnyPtr(byte(5))
