...
func Test_Cov4_AppendsIf_True(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "AppendsIf true", actual)
}
...
func Test_Cov4_AppendsIf_False(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "AppendsIf false", actual)
}
...
func Test_Cov4_PrependsIf_True(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "PrependsIf true", actual)
}
...
func Test_Cov4_PrependsIf_False(t *testing.T) {
	...
	actual := args.Map{"len": len(result)}
	expected := args.Map{"len": 1}
	expected.ShouldBeEqual(t, 0, "PrependsIf false", actual)
}
...
func Test_Cov4_NewNameValuesCollection(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "NewNameValuesCollection", actual)
}
...
func Test_Cov4_EmptyNameValuesCollection(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "EmptyNameValuesCollection", actual)
}
...
func Test_Cov4_NewNewNameValuesCollectionUsing(t *testing.T) {
	...
	expected := args.Map{"len": 1}
	expected.ShouldBeEqual(t, 0, "NewNewNameValuesCollectionUsing", actual)
}
...
func Test_Cov4_Collection_Error(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "Collection Error", actual)
}
...
func Test_Cov4_Collection_ErrorUsingMessage(t *testing.T) {
	...
	actual := args.Map{"hasErr": err != nil, "emptyNil": emptyErr == nil}
	expected := args.Map{"hasErr": true, "emptyNil": true}
	expected.ShouldBeEqual(t, 0, "Collection ErrorUsingMessage", actual)
}
...
func Test_Cov4_Collection_CsvStrings(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "Collection CsvStrings", actual)
}
...
func Test_Cov4_Collection_JoinCsvLine(t *testing.T) {
	...
	actual := args.Map{"notEmpty": result != ""}
	expected := args.Map{"notEmpty": true}
	expected.ShouldBeEqual(t, 0, "Collection JoinCsvLine", actual)
}
...
func Test_Cov4_Collection_JoinJsonStrings(t *testing.T) {
	...
	actual := args.Map{"notEmpty": result != ""}
	expected := args.Map{"notEmpty": true}
	expected.ShouldBeEqual(t, 0, "Collection JoinJsonStrings", actual)
}
...
func Test_Cov4_Collection_JsonStrings(t *testing.T) {
	...
	actual := args.Map{"len": len(result)}
	expected := args.Map{"len": 1}
	expected.ShouldBeEqual(t, 0, "Collection JsonStrings", actual)
}
...
func Test_Cov4_Collection_ClonePtr_Nil(t *testing.T) {
	...
	actual := args.Map{"isNil": result == nil}
	expected := args.Map{"isNil": true}
	expected.ShouldBeEqual(t, 0, "Collection ClonePtr nil", actual)
}
...
func Test_Cov4_Collection_HasCompiledString(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "Collection HasCompiledString", actual)
}
...
func Test_Cov4_Collection_HasCompiledString_Nil(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "Collection HasCompiledString nil", actual)
}
...
func Test_Cov4_Collection_InvalidateLazyString_Nil(t *testing.T) {
	...
	actual := args.Map{"ok": true}
	expected := args.Map{"ok": true}
	expected.ShouldBeEqual(t, 0, "Collection InvalidateLazyString nil", actual)
}
...
func Test_Cov4_Collection_String_WithCache(t *testing.T) {
	...
	actual := args.Map{"notEmpty": result != ""}
	expected := args.Map{"notEmpty": true}
	expected.ShouldBeEqual(t, 0, "Collection String with cache", actual)
}
...
func Test_Cov4_Collection_Length_Nil(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "Collection Length nil", actual)
}
...
func Test_Cov4_Instance_JsonString_UnserializableValue(t *testing.T) {
	...
	expected.ShouldBeEqual(t, 0, "Instance JsonString unserializable", actual)
}
