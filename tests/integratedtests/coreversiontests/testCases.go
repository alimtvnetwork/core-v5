	...
	versionCreationUsingStringTestCases = []testWrapper{
		{
			...
			ExpectedInput: []string{
				...
				"12 : invalid - v-1.555.*.11",
				"13 : invalid - v-1.555.*.12",
				"14 : invalid - v8v-1.555.*.13",
				"15 : invalid - v8v-1.x555.*.u14",
				"16 : invalid - v8v-1.*.*.u15",
				"17 : invalid - v5.-5",
				"18 : invalid - v10.-6",
				"19 : v11...7 (compact: 11...7, display: v11...7)",
				"20 : v12...8 (compact: 12...8, display: v12...8)",
				"21 : invalid - vxv12...9",
				"22 : v12..5 (compact: 12..5, display: v12..5)",
				"23 : v13..6 (compact: 13..6, display: v13..6)",
				"24 : v14..7 (compact: 14..7, display: v14..7)",
				"25 : invalid - ",
			},
