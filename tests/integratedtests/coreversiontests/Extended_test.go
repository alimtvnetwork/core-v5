...
func TestVersion_NilHas(t *testing.T) {
	var v *coreversion.Version
	if v.HasMajor() { t.Error("nil should not have major") }
	if v.HasMinor() { t.Error("nil should not have minor") }
	if v.HasPatch() { t.Error("nil should not have patch") }
	if v.HasBuild() { t.Error("nil should not have build") }
	if !v.IsMajorInvalid() { t.Error("nil major should be invalid") }
}

// TestVersion_Empty verifies empty version.
func TestVersion_Empty(t *testing.T) {
	v := coreversion.New.Default("")
	if !v.IsEmptyOrInvalid() { t.Error("empty should be invalid") }
	if v.HasAnyItem() { t.Error("empty should not have items") }
	if v.IsDefined() { t.Error("empty should not be defined") }
}
...
func TestVersion_Comparison(t *testing.T) {
	...
	if !v1.IsEqual(&v2) { t.Error("v1 should equal v2") }
	if v1.IsEqual(&v3) { t.Error("v1 should not equal v3") }
	if !v1.IsLeftLessThan(&v3) { t.Error("v1 should be less than v3") }
	if !v3.IsLeftGreaterThan(&v1) { t.Error("v3 should be greater than v1") }
	if !v1.IsLeftLessThanOrEqual(&v2) { t.Error("v1 should be <= v2") }
	if !v1.IsLeftGreaterThanOrEqual(&v2) { t.Error("v1 should be >= v2") }
}

// TestVersion_AtLeast verifies AtLeast.
func TestVersion_AtLeast(t *testing.T) {
	v := coreversion.New.Default("v2.1.0")
	if !v.IsAtLeast("v2.0.0") { t.Error("v2.1.0 should be at least v2.0.0") }
	if v.IsAtLeast("v3.0.0") { t.Error("v2.1.0 should not be at least v3.0.0") }
}
...
func TestVersion_IsEqualVersionString(t *testing.T) {
	...
	if !v.IsEqualVersionString("v1.0.0") { t.Error("should be equal") }
	if !v.IsEqualVersionString("1.0.0") { t.Error("should be equal without v prefix") }
}

// TestVersion_IsLowerVersionString verifies lower version string.
func TestVersion_IsLowerVersionString(t *testing.T) {
	v := coreversion.New.Default("v1.0.0")
	if !v.IsLowerVersionString("v2.0.0") { t.Error("v1 should be lower than v2") }
}

// TestVersion_IsLowerEqualVersionString verifies lower or equal.
func TestVersion_IsLowerEqualVersionString(t *testing.T) {
	v := coreversion.New.Default("v1.0.0")
	if !v.IsLowerEqualVersionString("v1.0.0") { t.Error("v1 should be <= v1") }
}

// TestVersion_IsVersionCompareEqual verifies compact comparison.
func TestVersion_IsVersionCompareEqual(t *testing.T) {
	v := coreversion.New.Default("v1.2.3")
	if !v.IsVersionCompareEqual("1.2.3") { t.Error("should be equal") }
	if !v.IsVersionCompareNotEqual("2.0.0") { t.Error("should not be equal") }

	var nilV *coreversion.Version
	if !nilV.IsVersionCompareEqual("") { t.Error("nil with empty should be equal") }
	if nilV.IsVersionCompareEqual("1.0") { t.Error("nil with non-empty should not be equal") }
}
...
func TestVersion_ClonePtr(t *testing.T) {
	var nilV *coreversion.Version
	if nilV.ClonePtr() != nil { t.Error("nil clone should be nil") }

	v := coreversion.New.Default("v1.0")
	ptr := v.ClonePtr()
	if ptr == nil { t.Error("clone should not be nil") }
}
...
func TestVersion_AllVersionValues(t *testing.T) {
	...
	if len(vals) == 0 { t.Error("should have values") }
}
...
func TestVersion_AllValidVersionValues(t *testing.T) {
	...
	if len(vals) == 0 { t.Error("should have valid values") }
}
...
func TestVersion_IsMajorAtLeast(t *testing.T) {
	...
	if !v.IsMajorAtLeast(1) { t.Error("2 should be at least 1") }
	if !v.IsMajorAtLeast(2) { t.Error("2 should be at least 2") }
	if v.IsMajorAtLeast(3) { t.Error("2 should not be at least 3") }
}
...
func TestVersion_IsMajorMinorAtLeast(t *testing.T) {
	...
	if !v.IsMajorMinorAtLeast(2, 3) { t.Error("2.3 should be at least 2.3") }
	if !v.IsMajorMinorAtLeast(2, 2) { t.Error("2.3 should be at least 2.2") }
	if v.IsMajorMinorAtLeast(2, 4) { t.Error("2.3 should not be at least 2.4") }
}
...
func TestNewCreator_Spread(t *testing.T) {
	...
	if v.VersionMajor != 1 { t.Error("major should be 1") }
...
func TestNewCreator_AllVariants(t *testing.T) {
	...
	if v.VersionMinor != 2 { t.Error("minor should be 2") }

	v = coreversion.New.MajorMinorPatch("1", "2", "3")
	if v.VersionPatch != 3 { t.Error("patch should be 3") }

	v = coreversion.New.MajorMinorPatchBuild("1", "2", "3", "4")
	if v.VersionBuild != 4 { t.Error("build should be 4") }

	v = coreversion.New.AllInt(1, 2, 3, 4)
	if v.VersionBuild != 4 { t.Error("AllInt build should be 4") }

	v = coreversion.New.AllByte(1, 2, 3, 4)
	if v.VersionBuild != 4 { t.Error("AllByte build should be 4") }

	v = coreversion.New.MajorMinorInt(1, 2)
	if v.VersionMinor != 2 { t.Error("MajorMinorInt minor should be 2") }

	v = coreversion.New.MajorMinorPatchInt(1, 2, 3)
	if v.VersionPatch != 3 { t.Error("MajorMinorPatchInt patch should be 3") }
}
...
func TestVersion_Json(t *testing.T) {
	v := coreversion.New.Default("v1.2.3")
	j := v.Json()
	if j.HasError() { t.Error("json should not have error") }

	jp := v.JsonPtr()
	if jp == nil { t.Error("json ptr should not be nil") }
}
...
func TestVersion_IsMajorStringAtLeast(t *testing.T) {
	...
	if !v.IsMajorStringAtLeast("2") { t.Error("3 should be at least 2") }
}
...
func TestVersion_InvalidOrZero(t *testing.T) {
	...
	if !v.IsMajorInvalidOrZero() { t.Error("0 should be invalid or zero") }
	if !v.IsMinorInvalidOrZero() { t.Error("0 should be invalid or zero") }
	if !v.IsPatchInvalidOrZero() { t.Error("0 should be invalid or zero") }
	if !v.IsBuildInvalidOrZero() { t.Error("0 should be invalid or zero") }
}
...
func TestVersion_NonPtrAndPtr(t *testing.T) {
	v := coreversion.New.Default("v1.0")
	np := v.NonPtr()
	if np.VersionMajor != 1 { t.Error("NonPtr major should be 1") }
	p := v.Ptr()
	if p == nil { t.Error("Ptr should not be nil") }
}
