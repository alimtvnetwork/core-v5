...
func TestCollection_JsonString_C11(t *testing.T) {
	c := New.Collection.Strings([]string{"a", "b"})
	s := c.JsonString()
	if s == "" { t.Fatal("expected non-empty") }
}

func TestCollection_JsonStringMust_C11(t *testing.T) {
	c := New.Collection.Strings([]string{"a"})
	s := c.JsonStringMust()
	if s == "" { t.Fatal("expected non-empty") }
}

func TestCollection_HasAnyItem_C11(t *testing.T) {
	c := New.Collection.Strings([]string{"a"})
	if !c.HasAnyItem() { t.Fatal("expected true") }
}

func TestCollection_LastIndex_C11(t *testing.T) {
	c := New.Collection.Strings([]string{"a", "b"})
	if c.LastIndex() != 1 { t.Fatal("expected 1") }
}

func TestCollection_HasIndex_C11(t *testing.T) {
	c := New.Collection.Strings([]string{"a", "b"})
...
func TestCollection_ListStringsPtr_C11(t *testing.T) {
	c := New.Collection.Strings([]string{"a"})
	if len(c.ListStringsPtr()) != 1 { t.Fatal("expected 1") }
}

func TestCollection_ListStrings_C11(t *testing.T) {
	c := New.Collection.Strings([]string{"a"})
	if len(c.ListStrings()) != 1 { t.Fatal("expected 1") }
}

func TestCollection_StringJSON_C11(t *testing.T) {
	c := New.Collection.Strings([]string{"a"})
	s := c.StringJSON()
	if s == "" { t.Fatal("expected non-empty") }
}

func TestCollection_RemoveAt_C11(t *testing.T) {
...
func TestCollection_Count_C11(t *testing.T) {
	c := New.Collection.Strings([]string{"a"})
	if c.Count() != 1 { t.Fatal("expected 1") }
}

func TestCollection_Capacity_C11(t *testing.T) {
	c := New.Collection.Cap(10)
	if c.Capacity() == 0 { t.Fatal("expected > 0") }
}

func TestCollection_Capacity_Nil_C11(t *testing.T) {
	c := &Collection{}
	if c.Capacity() != 0 { t.Fatal("expected 0") }
}

func TestCollection_IsEquals_C11(t *testing.T) {
	a := New.Collection.Strings([]string{"a", "b"})
	b := New.Collection.Strings([]string{"a", "b"})
	if !a.IsEquals(b) { t.Fatal("expected true") }
}

func TestCollection_IsEquals_Different_C11(t *testing.T) {
	a := New.Collection.Strings([]string{"a"})
	b := New.Collection.Strings([]string{"b"})
	if a.IsEquals(b) { t.Fatal("expected false") }
}

func TestCollection_IsEquals_BothNil_C11(t *testing.T) {
	var a, b *Collection
	result, handled := isCollectionPrecheckEqual(a, b)
	if !handled || !result { t.Fatal("expected true") }
}

func TestCollection_IsEquals_OneNil_C11(t *testing.T) {
	a := New.Collection.Strings([]string{"a"})
	result, handled := isCollectionPrecheckEqual(a, nil)
	if !handled || result { t.Fatal("expected false") }
}

func TestCollection_IsEquals_BothEmpty_C11(t *testing.T) {
	a := New.Collection.Cap(0)
	b := New.Collection.Cap(0)
	if !a.IsEquals(b) { t.Fatal("expected true") }
}

func TestCollection_IsEquals_DiffLength_C11(t *testing.T) {
	a := New.Collection.Strings([]string{"a"})
	b := New.Collection.Strings([]string{"a", "b"})
	if a.IsEquals(b) { t.Fatal("expected false") }
}

func TestCollection_IsEqualsWithSensitive_CaseInsensitive_C11(t *testing.T) {
...
func TestCollection_IsEmptyLock_C11(t *testing.T) {
	c := New.Collection.Cap(0)
	if !c.IsEmptyLock() { t.Fatal("expected true") }
}

func TestCollection_HasItems_C11(t *testing.T) {
	c := New.Collection.Strings([]string{"a"})
...
func TestCollection_AddLock_C11(t *testing.T) {
	c := New.Collection.Cap(5)
	c.AddLock("a")
	if c.Length() != 1 { t.Fatal("expected 1") }
}

func TestCollection_AddNonEmpty_C11(t *testing.T) {
	c := New.Collection.Cap(5)
	c.AddNonEmpty("")
	c.AddNonEmpty("a")
	if c.Length() != 1 { t.Fatal("expected 1") }
...
func TestCollection_AddNonEmptyWhitespace_C11(t *testing.T) {
	c := New.Collection.Cap(5)
...
func TestCollection_AddError_C11(t *testing.T) {
	c := New.Collection.Cap(5)
	c.AddError(nil) // skip
	if c.Length() != 0 { t.Fatal("expected 0") }
}

func TestCollection_AsDefaultError_C11(t *testing.T) {
	c := New.Collection.Strings([]string{"err1"})
	e := c.AsDefaultError()
	if e == nil { t.Fatal("expected error") }
}

func TestCollection_AsError_Empty_C11(t *testing.T) {
	c := New.Collection.Cap(0)
	e := c.AsError("\n")
	if e != nil { t.Fatal("expected nil") }
}

func TestCollection_EachItemSplitBy_C11(t *testing.T) {
	c := New.Collection.Strings([]string{"a,b", "c,d"})
	items := c.EachItemSplitBy(",")
	if len(items) != 4 { t.Fatal("expected 4") }
}

func TestCollection_ConcatNew_C11(t *testing.T) {
	c := New.Collection.Strings([]string{"a"})
	c2 := c.ConcatNew(0, "b", "c")
	if c2.Length() != 3 { t.Fatal("expected 3") }
}

func TestCollection_ConcatNew_Empty_C11(t *testing.T) {
	c := New.Collection.Strings([]string{"a"})
	c2 := c.ConcatNew(0)
	if c2.Length() != 1 { t.Fatal("expected 1") }
}

func TestCollection_ToError_C11(t *testing.T) {
	c := New.Collection.Strings([]string{"e1"})
	_ = c.ToError("\n")
}

func TestCollection_ToDefaultError_C11(t *testing.T) {
	c := New.Collection.Strings([]string{"e1"})
	_ = c.ToDefaultError()
}

func TestCollection_AddIfMany_C11(t *testing.T) {
	c := New.Collection.Cap(5)
...
func TestCollection_AddFunc_C11(t *testing.T) {
	c := New.Collection.Cap(5)
	c.AddFunc(func() string { return "x" })
	if c.Length() != 1 { t.Fatal("expected 1") }
}

func TestCollection_AddsLock_C11(t *testing.T) {
	c := New.Collection.Cap(5)
	c.AddsLock("a", "b")
	if c.Length() != 2 { t.Fatal("expected 2") }
}

func TestCollection_AddStrings_C11(t *testing.T) {
	c := New.Collection.Cap(5)
	c.AddStrings([]string{"a", "b"})
	if c.Length() != 2 { t.Fatal("expected 2") }
}

func TestCollection_AddCollection_C11(t *testing.T) {
	c := New.Collection.Cap(5)
...
func TestCollection_AddCollection_Empty_C11(t *testing.T) {
	c := New.Collection.Cap(5)
	c.AddCollection(New.Collection.Cap(0))
	if c.Length() != 0 { t.Fatal("expected 0") }
}

func TestCollection_AddCollections_C11(t *testing.T) {
	c := New.Collection.Cap(5)
...
func TestCollection_LengthLock_C11(t *testing.T) {
	c := New.Collection.Strings([]string{"a"})
...
func TestHashmap_AddOrUpdateKeyStrValFloat_C11(t *testing.T) {
	hm := New.Hashmap.Cap(5)
...
func TestHashmap_AddOrUpdateKeyStrValFloat64_C11(t *testing.T) {
	hm := New.Hashmap.Cap(5)
...
func TestHashmap_AddOrUpdateKeyStrValAny_C11(t *testing.T) {
	hm := New.Hashmap.Cap(5)
	hm.AddOrUpdateKeyStrValAny("k", 42)
	if !hm.Has("k") { t.Fatal("expected found") }
}

func TestHashmap_AddOrUpdateKeyValueAny_C11(t *testing.T) {
	hm := New.Hashmap.Cap(5)
	hm.AddOrUpdateKeyValueAny(KeyAnyValuePair{Key: "k", Value: 42})
	if !hm.Has("k") { t.Fatal("expected found") }
}

func TestHashmap_AddOrUpdateKeyVal_C11(t *testing.T) {
	hm := New.Hashmap.Cap(5)
...
func TestHashmap_Set_C11(t *testing.T) {
	hm := New.Hashmap.Cap(5)
	hm.Set("k", "v")
	if !hm.Has("k") { t.Fatal("expected found") }
}

func TestHashmap_SetTrim_C11(t *testing.T) {
	hm := New.Hashmap.Cap(5)
	hm.SetTrim("  k  ", "  v  ")
	if !hm.Has("k") { t.Fatal("expected found") }
}

func TestHashmap_SetBySplitter_C11(t *testing.T) {
	hm := New.Hashmap.Cap(5)
...
func TestHashmap_SetBySplitter_NoSplit_C11(t *testing.T) {
	hm := New.Hashmap.Cap(5)
...
func TestHashmap_Contains_C11(t *testing.T) {
	hm := New.Hashmap.KeyValues(KeyValuePair{Key: "k", Value: "v"})
	if !hm.Contains("k") { t.Fatal("expected true") }
}

func TestHashmap_ContainsLock_C11(t *testing.T) {
	hm := New.Hashmap.KeyValues(KeyValuePair{Key: "k", Value: "v"})
	if !hm.ContainsLock("k") { t.Fatal("expected true") }
}

func TestHashmap_IsKeyMissing_C11(t *testing.T) {
	hm := New.Hashmap.KeyValues(KeyValuePair{Key: "k", Value: "v"})
	if hm.IsKeyMissing("k") { t.Fatal("expected false") }
	if !hm.IsKeyMissing("x") { t.Fatal("expected true") }
}

func TestHashmap_IsKeyMissingLock_C11(t *testing.T) {
	hm := New.Hashmap.KeyValues(KeyValuePair{Key: "k", Value: "v"})
	if hm.IsKeyMissingLock("k") { t.Fatal("expected false") }
}

func TestHashmap_HasLock_C11(t *testing.T) {
	hm := New.Hashmap.KeyValues(KeyValuePair{Key: "k", Value: "v"})
	if !hm.HasLock("k") { t.Fatal("expected true") }
}

func TestHashmap_HasAllStrings_C11(t *testing.T) {
...
func TestHashmap_AddOrUpdateMap_C11(t *testing.T) {
	hm := New.Hashmap.Cap(5)
	hm.AddOrUpdateMap(map[string]string{"a": "1"})
	if !hm.Has("a") { t.Fatal("expected found") }
}

func TestHashmap_AddsOrUpdates_C11(t *testing.T) {
	hm := New.Hashmap.Cap(5)
	hm.AddsOrUpdates(
		KeyValuePair{Key: "a", Value: "1"},
		KeyValuePair{Key: "b", Value: "2"},
...
func TestHashmap_AddOrUpdateLock_C11(t *testing.T) {
	hm := New.Hashmap.Cap(5)
	hm.AddOrUpdateLock("k", "v")
	if !hm.Has("k") { t.Fatal("expected found") }
}

func TestHashmap_AddOrUpdateKeyValues_C11(t *testing.T) {
	hm := New.Hashmap.Cap(5)
	hm.AddOrUpdateKeyValues(KeyValuePair{Key: "a", Value: "1"})
	if hm.Length() != 1 { t.Fatal("expected 1") }
}

func TestHashmap_AddOrUpdateKeyAnyValues_C11(t *testing.T) {
	hm := New.Hashmap.Cap(5)
	hm.AddOrUpdateKeyAnyValues(KeyAnyValuePair{Key: "a", Value: 1})
	if hm.Length() != 1 { t.Fatal("expected 1") }
}

func TestHashmap_AddOrUpdateHashmap_C11(t *testing.T) {
...
func TestHashmap_AddOrUpdateHashmap_Nil_C11(t *testing.T) {
	hm := New.Hashmap.Cap(5)
	hm.AddOrUpdateHashmap(nil)
	if hm.Length() != 0 { t.Fatal("expected 0") }
}

func TestHashmap_AddOrUpdateCollection_C11(t *testing.T) {
...
func TestHashmap_AddOrUpdateCollection_Empty_C11(t *testing.T) {
	hm := New.Hashmap.Cap(5)
	hm.AddOrUpdateCollection(nil, nil)
	if hm.Length() != 0 { t.Fatal("expected 0") }
}

func TestHashmap_AddOrUpdateCollection_LenMismatch_C11(t *testing.T) {
...
func TestHashmap_ConcatNew_C11(t *testing.T) {
	hm1 := New.Hashmap.KeyValues(KeyValuePair{Key: "a", Value: "1"})
...
func TestHashset_HasItems_C11(t *testing.T) {
	hs := New.Hashset.Strings([]string{"a"})
	if !hs.HasItems() { t.Fatal("expected true") }
}

func TestHashset_HasItems_Nil_C11(t *testing.T) {
	var hs *Hashset
...
func TestSimpleSlice_HasItems_C11(t *testing.T) {
...
func TestValidValue_NewValidValue_C11(t *testing.T) {
	vv := NewValidValue("hello")
	if !vv.IsValid || vv.Value != "hello" { t.Fatal("unexpected") }
}

func TestValidValue_NewInvalidValue_C11(t *testing.T) {
...
func TestLeftRightFromSplit_Valid_C11(t *testing.T) {
	lr := NewLeftRightFromSplit("key=val", "=")
	if lr.Left != "key" || lr.Right != "val" { t.Fatal("unexpected") }
}

func TestLeftRightFromSplit_NoSplit_C11(t *testing.T) {
...
func TestLeftMiddleRightFromSplit_Valid_C11(t *testing.T) {
...
func TestCollectionsOfCollection_HasItems_C11(t *testing.T) {
...
func TestCollectionsOfCollection_AllIndividualItemsLength_C11(t *testing.T) {
	coc := New.CollectionsOfCollection.Cap(5)
	c := New.Collection.Strings([]string{"a", "b"})
	coc.Add(c)
...
func TestCollectionsOfCollection_Items_C11(t *testing.T) {
	coc := New.CollectionsOfCollection.Cap(5)
	c := New.Collection.Strings([]string{"a"})
	coc.Add(c)
...
func TestCollectionsOfCollection_List_C11(t *testing.T) {
	coc := New.CollectionsOfCollection.Cap(5)
	c := New.Collection.Strings([]string{"a", "b"})
	coc.Add(c)
	list := coc.List(0)
...
func TestCollectionsOfCollection_ToCollection_C11(t *testing.T) {
	coc := New.CollectionsOfCollection.Cap(5)
	c := New.Collection.Strings([]string{"a"})
	coc.Add(c)
...
func TestCollectionsOfCollection_AddStrings_C11(t *testing.T) {
	coc := New.CollectionsOfCollection.Cap(5)
	coc.AddStrings(false, []string{"a", "b"})
	if coc.Length() != 1 { t.Fatal("expected 1") }
}

func TestCollectionsOfCollection_AddStrings_Empty_C11(t *testing.T) {
	coc := New.CollectionsOfCollection.Cap(5)
	coc.AddStrings(false, nil)
	if coc.Length() != 0 { t.Fatal("expected 0") }
}

func TestCollectionsOfCollection_AddsStringsOfStrings_C11(t *testing.T) {
	coc := New.CollectionsOfCollection.Cap(5)
	coc.AddsStringsOfStrings(false, []string{"a"}, []string{"b"})
	if coc.Length() != 2 { t.Fatal("expected 2") }
}

func TestCollectionsOfCollection_Adds_C11(t *testing.T) {
	coc := New.CollectionsOfCollection.Cap(5)
	c := *New.Collection.Strings([]string{"a"})
	coc.Adds(c)
	if coc.Length() != 1 { t.Fatal("expected 1") }
...
func TestCollectionsOfCollection_AddCollections_C11(t *testing.T) {
	coc := New.CollectionsOfCollection.Cap(5)
	c := *New.Collection.Strings([]string{"a"})
...
func TestCollectionsOfCollection_String_C11(t *testing.T) {
	coc := New.CollectionsOfCollection.Cap(5)
	c := New.Collection.Strings([]string{"a"})
	coc.Add(c)
	s := coc.String()
...
func TestCollectionsOfCollection_JsonModel_C11(t *testing.T) {
	coc := New.CollectionsOfCollection.Cap(5)
	m := coc.JsonModel()
	_ = m
}

func TestCollectionsOfCollection_JsonModelAny_C11(t *testing.T) {
	coc := New.CollectionsOfCollection.Cap(5)
	a := coc.JsonModelAny()
	_ = a
}

func TestCollectionsOfCollection_AsJsoner_C11(t *testing.T) {
	coc := New.CollectionsOfCollection.Cap(5)
	_ = coc.AsJsoner()
}

func TestCollectionsOfCollection_AsJsonParseSelfInjector_C11(t *testing.T) {
	coc := New.CollectionsOfCollection.Cap(5)
	_ = coc.AsJsonParseSelfInjector()
}

func TestCollectionsOfCollection_AsJsonMarshaller_C11(t *testing.T) {
	coc := New.CollectionsOfCollection.Cap(5)
	_ = coc.AsJsonMarshaller()
}

func TestCollectionsOfCollection_AsJsonContractsBinder_C11(t *testing.T) {
	coc := New.CollectionsOfCollection.Cap(5)
...
func TestCloneSlice_Valid_C11(t *testing.T) {
	orig := []string{"a", "b"}
...
func TestCloneSlice_Nil_C11(t *testing.T) {
	cloned := CloneSlice(nil)
	if len(cloned) != 0 { t.Fatal("expected empty") }
}

func TestCloneSliceIf_True_C11(t *testing.T) {
	cloned := CloneSliceIf(true, "a", "b")
	if len(cloned) != 2 { t.Fatal("expected 2") }
}

func TestCloneSliceIf_False_C11(t *testing.T) {
...
func TestKeyAnyValuePair_ValueString_C11(t *testing.T) {
...
func TestAllIndividualStringsOfStringsLength_C11(t *testing.T) {
	input := [][]string{{"a", "b"}, {"c"}}
	l := AllIndividualStringsOfStringsLength(input)
	if l != 3 { t.Fatal("expected 3") }
}

func TestAllIndividualStringsOfStringsLength_Nil_C11(t *testing.T) {
