...
import (
	...
	"gitlab.com/auk-go/core/cmd/main"
	...
	sampleFuncTestCases = []coretestcases.CaseV1{
		{
			...
			ExpectedInput: []string{
				"0 : 1 alim 1 alim 2 {", First":"alim 1","LeftRight":{"Left":"l","Right":"r","Expect":"e"},"Draft":{"SampleString1":"alim 1","SampleString2":"","SampleInteger":0,"Lines":null,"RawBytes":null}}
			[{
...
func Test_SampleFunc_Verification(t *testing.T) {
	for caseIndex, testCase := range sampleFuncTestCases {
		...
		for i, input := range inputs {
			...
			inArg[]
			main.AlimStruct4 := input.Fifth.([]main.AlimStruct)
