...
const (
	...
	SpaceWithColon                                   = " : "
	SprintFormatNumberWithColonFormat                = "%d:%d"
	SprintFormatAnyValueWithColonFormat              = "%v:%v"
	SprintFormatAnyValueWithCommaFormat              = "%v,%v"
	SprintFormatAnyValueWithPipeFormat               = "%v|%v"
	SprintFormatAnyNameValueWithColonFormat          = "%#v:%#v"
	SprintFormatAnyNameValueWithPipeFormat           = "%#v|%#v"
	...
	ParenthesisQuotationWrapFormat                   = "(\"%v\")"
	...
	SpaceHypheAngelBracketSpaceRefWrapFormat         = " -> Ref(%v)"
